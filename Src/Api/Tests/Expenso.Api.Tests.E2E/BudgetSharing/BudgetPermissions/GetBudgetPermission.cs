...
internal sealed class GetBudgetPermission : BudgetPermissionTestBase
{
    ...
    public async Task Should_ReturnExpectedResult()
    {
        ...
        string requestPath = $"budget-sharing/budget-permissions/{BudgetPermissionDataProvider.BudgetPermissionIds[0]}";
        ...
        response?.Id.Should().Be(BudgetPermissionDataProvider.BudgetPermissionIds[0]);
    }
