...
namespace Expenso.UserPreferences.Tests.UnitTests.Validators.CreatePreference.Cases;
...
internal sealed class Validate : CreatePreferenceCommandValidatorTestBase
{
    ...
    public void Should_ReturnValidationResultWithCorrectMessage_When_UserIdIsEmpty()
    {
        ...
        CreatePreferenceCommand command = new CreatePreferenceCommand(new CreatePreferenceRequest(userId));
