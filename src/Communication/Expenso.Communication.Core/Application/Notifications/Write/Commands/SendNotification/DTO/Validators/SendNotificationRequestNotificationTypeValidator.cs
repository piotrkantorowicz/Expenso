...
internal sealed class
    SendNotificationRequestNotificationTypeValidator : AbstractValidator<SendNotificationRequestNotificationType>
{
    public SendNotificationRequestNotificationTypeValidator()
    {
