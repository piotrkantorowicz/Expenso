...
internal sealed class
    UpdatePreferenceRequestFinancePreferenceValidator : AbstractValidator<UpdatePreferenceRequestFinancePreference>
{
    public UpdatePreferenceRequestFinancePreferenceValidator()
    {
