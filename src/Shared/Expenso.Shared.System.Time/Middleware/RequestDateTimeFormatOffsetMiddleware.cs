...
internal sealed class RequestDateTimeFormatOffsetMiddleware : IMiddleware
{
    ...
    public RequestDateTimeFormatOffsetMiddleware(ILoggerFactory loggerFactory, RequestTimeZoneOptions options,
        ITimeZoneClock timeZoneClock,
        [FromKeyedServices(key: RequestProviderValueType.DateTimeOffsetFormat)] IProviderInput providerInput)
    {
    ...
    public async Task InvokeAsync(HttpContext httpContext, RequestDelegate next)
    {
        ...
        string defaultRequestDateTimeOffsetFormat = _options.DateTimeOffsetFormat;
        ...
        foreach (IRequestProvider provider in _options.RequestProviders)
        {
            ...
            try
            {
                defaultRequestDateTimeOffsetFormat =
                    new RequestDateTimeOffsetFormat(format: providerTimeZoneResult.Value!);
        ...
        httpContext.Features.Set<IRequestDateTimeOffsetFormatFeature>(
            instance: new RequestDateTimeOffsetFormatFeature(
                requestDateTimeOffsetFormat: defaultRequestDateTimeOffsetFormat, provider: usedProvider));
